...
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/usr/share/harbour-picross/lib
...
Makefile: harbour-Picross.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
harbour-picross.o: src/harbour-picross.cpp /usr/include/qt5/QtSql/QtSql \
...
install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/harbour-picross || mkdir -p $(INSTALL_ROOT)/usr/share/harbour-picross
	-$(INSTALL_DIR) /home/mersdk/share/Projets/harbour-picross/qml $(INSTALL_ROOT)/usr/share/harbour-picross/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/harbour-picross/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/harbour-picross/ 
...
install_desktop: first FORCE
	...
	-$(INSTALL_FILE) /home/mersdk/share/Projets/harbour-picross/harbour-picross.desktop $(INSTALL_ROOT)/usr/share/applications/

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/harbour-picross.desktop
...
install_icon: first FORCE
	...
	-$(INSTALL_FILE) /home/mersdk/share/Projets/harbour-picross/harbour-picross.png $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/harbour-picross.png
