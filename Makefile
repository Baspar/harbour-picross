...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_NO_DEBUG -DQT_QUICK_LIB -DQT_GUI_LIB -DQT_SQL_LIB -DQT_QML_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB
...
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++ -I. -I/usr/include/sailfishapp -I/usr/include/mdeclarativecache5 -I/usr/include/qt5 -I/usr/include/qt5/QtQuick -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtSql -I/usr/include/qt5/QtQml -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/usr/share/Picross/lib
LIBS          = $(SUBLIBS) -pie -rdynamic -L/usr/lib/ -lsailfishapp -lmdeclarativecache5 -L/usr/lib -lQt5Quick -lQt5Gui -lQt5Sql -lQt5Qml -lQt5Network -lQt5Core -lGLESv2 -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: Picross.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/Picross1.0.0 || mkdir -p .tmp/Picross1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Picross1.0.0/ && $(COPY_FILE) --parents src/Picross.cpp .tmp/Picross1.0.0/ && $(COPY_FILE) --parents translations/Picross-de.ts .tmp/Picross1.0.0/ && (cd `dirname .tmp/Picross1.0.0` && $(TAR) Picross1.0.0.tar Picross1.0.0 && $(COMPRESS) Picross1.0.0.tar) && $(MOVE) `dirname .tmp/Picross1.0.0`/Picross1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Picross1.0.0
...
Picross.o: src/Picross.cpp /usr/include/qt5/QtSql/QtSql \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Picross.o src/Picross.cpp

####### Install

install_qm: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/Picross/translations || mkdir -p $(INSTALL_ROOT)/usr/share/Picross/translations
	lupdate "/home/mersdk/share/Projets/Picross/src" "/home/mersdk/share/Projets/Picross/qml" -ts "/home/mersdk/share/Projets/Picross/translations/Picross.ts" "/home/mersdk/share/Projets/Picross/translations/Picross-de.ts" && mkdir -p translations && [ "/home/mersdk/share/Projets/Picross" != "/home/mersdk/share/Projets/Picross" -a 1 -eq 1 ] && cp -af "/home/mersdk/share/Projets/Picross/translations/Picross-de.ts" "/home/mersdk/share/Projets/Picross/translations" || : ; [ 1 -eq 1 ] && lrelease -nounfinished "/home/mersdk/share/Projets/Picross/translations/Picross-de.ts" || :
	-$(INSTALL_FILE) /home/mersdk/share/Projets/Picross/translations/Picross-de.qm $(INSTALL_ROOT)/usr/share/Picross/translations/

uninstall_qm: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/Picross/translations/Picross-de.qm
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/Picross/translations/ 


install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/Picross || mkdir -p $(INSTALL_ROOT)/usr/share/Picross
	-$(INSTALL_DIR) /home/mersdk/share/Projets/Picross/qml $(INSTALL_ROOT)/usr/share/Picross/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/Picross/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/Picross/ 
...
install_desktop: first FORCE
	...
	-$(INSTALL_FILE) /home/mersdk/share/Projets/Picross/Picross.desktop $(INSTALL_ROOT)/usr/share/applications/

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/Picross.desktop
...
install_icon: first FORCE
	...
	-$(INSTALL_FILE) /home/mersdk/share/Projets/Picross/Picross.png $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/Picross.png
