...
LIBS          = $(SUBLIBS) -pie -rdynamic -L/usr/lib/ -lsailfishapp -lmdeclarativecache5 -lQt5Quick -lQt5Gui -lQt5Sql -lQt5Qml -lQt5Network -lQt5Core -lGLESv2 -lpthread 
AR            = ar cqs
RANLIB        = 
